...
public final class CutoutAvatarExtractionParams implements RequestParams {
    private final FileInput image;
    private final String returnForm;

    private CutoutAvatarExtractionParams(Builder builder) {
    ...
    public static final class Builder {
        ...
        public CutoutAvatarExtractionParams build() {
            Objects.requireNonNull(image, "image");
            return new CutoutAvatarExtractionParams(this);
        }
    }
}
