...
public final class CutoutHumanBackgroundRemovalParams implements RequestParams {
    private final FileInput image;
    private final String returnForm;

    private CutoutHumanBackgroundRemovalParams(Builder builder) {
    ...
    public static final class Builder {
        ...
        public CutoutHumanBackgroundRemovalParams build() {
            Objects.requireNonNull(image, "image");
            return new CutoutHumanBackgroundRemovalParams(this);
        }
    }
}
