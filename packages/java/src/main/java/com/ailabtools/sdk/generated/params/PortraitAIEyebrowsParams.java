...
public final class PortraitAIEyebrowsParams implements RequestParams {
    private final FileInput image;
    private final FileInput referenceImage;
    private final String resolution;

    private PortraitAIEyebrowsParams(Builder builder) {
    ...
    public static final class Builder {
        ...
        public PortraitAIEyebrowsParams build() {
            Objects.requireNonNull(image, "image");
            Objects.requireNonNull(referenceImage, "referenceImage");
            return new PortraitAIEyebrowsParams(this);
        }
    }
}
