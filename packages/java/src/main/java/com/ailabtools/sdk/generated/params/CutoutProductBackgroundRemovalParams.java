...
/** Parameters for Product Background Removal API. */
public final class CutoutProductBackgroundRemovalParams implements RequestParams {
    private final FileInput image;
    private final String returnForm;

    private CutoutProductBackgroundRemovalParams(Builder builder) {
    ...
    public static final class Builder {
        ...
        public CutoutProductBackgroundRemovalParams build() {
            Objects.requireNonNull(image, "image");
            return new CutoutProductBackgroundRemovalParams(this);
        }
    }
}
