...
public final class CutoutUniversalBackgroundRemovalParams implements RequestParams {
    private final FileInput image;
    private final String returnForm;

    private CutoutUniversalBackgroundRemovalParams(Builder builder) {
    ...
    public static final class Builder {
        ...
        public CutoutUniversalBackgroundRemovalParams build() {
            Objects.requireNonNull(image, "image");
            return new CutoutUniversalBackgroundRemovalParams(this);
        }
    }
}
