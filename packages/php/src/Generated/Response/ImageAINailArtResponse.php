...
final class ImageAINailArtResponse extends BaseResponse
{
    /** @param array<string, mixed> $metadata */
    private function __construct(
        public readonly ?ImageAINailArtResponseData $data,
        array $metadata,
    ) {
    ...
    public static function fromArray(array $payload): self
    {
        $data = isset($payload['data']) && is_array($payload['data'])
            ? ImageAINailArtResponseData::fromArray($payload['data'])
            : null;
