...
final class ImageAINailArtProResponse extends BaseResponse
{
    /** @param array<string, mixed> $metadata */
    private function __construct(
        public readonly ?ImageAINailArtProResponseData $data,
        array $metadata,
    ) {
    ...
    public static function fromArray(array $payload): self
    {
        $data = isset($payload['data']) && is_array($payload['data'])
            ? ImageAINailArtProResponseData::fromArray($payload['data'])
            : null;
