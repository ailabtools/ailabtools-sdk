...
final class ImagePhotoEditingResponse extends BaseResponse
{
    /** @param array<string, mixed> $metadata */
    private function __construct(
        public readonly ?ImagePhotoEditingResponseData $data,
        array $metadata,
    ) {
    ...
    public static function fromArray(array $payload): self
    {
        $data = isset($payload['data']) && is_array($payload['data'])
            ? ImagePhotoEditingResponseData::fromArray($payload['data'])
            : null;
