...
final class PortraitFaceAnalyzerParams
{
    public function __construct(
        ...
        public readonly ?string $faceAttributesType = null,
        ...
        public readonly ?int $needRotateDetection = null,
    ) {
    }
    ...
    public function toArray(): array
    {
        return [
            ...
            'face_attributes_type' => $this->faceAttributesType,
            'need_rotate_detection' => $this->needRotateDetection,
        ];
    }
}
