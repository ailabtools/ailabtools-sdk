...
final class PortraitFacialBeautificationProParams
{
    public function __construct(
        ...
        public readonly ?int $filterType = null,
    ...
    public function toArray(): array
    {
        return [
            ...
            'thinface' => $this->thinface,
            'shrink_face' => $this->shrinkFace,
            'enlarge_eye' => $this->enlargeEye,
            'remove_eyebrow' => $this->removeEyebrow,
