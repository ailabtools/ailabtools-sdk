...
/** Typed response data. */
@Serializable
public data class PortraitTryOnClothesProResponseData(
...
@Serializable
public data class PortraitTryOnClothesProResponse(
    ...
    @SerialName("data")
    public val data: PortraitTryOnClothesProResponseData? = null,
    @SerialName("image")
