...
/** Typed response data. */
@Serializable
public data class PortraitIntelligentFaceSlimmingResponseData(
...
@Serializable
public data class PortraitIntelligentFaceSlimmingResponse(
    ...
    @SerialName("data")
    public val data: PortraitIntelligentFaceSlimmingResponseData? = null,
    @SerialName("image")
