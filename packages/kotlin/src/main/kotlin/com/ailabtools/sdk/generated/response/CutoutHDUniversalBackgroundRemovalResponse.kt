...
/** Typed response data. */
@Serializable
public data class CutoutHDUniversalBackgroundRemovalResponseData(
...
@Serializable
public data class CutoutHDUniversalBackgroundRemovalResponse(
    @SerialName("request_id")
    ...
    @SerialName("data")
    public val data: CutoutHDUniversalBackgroundRemovalResponseData? = null,
    @SerialName("image")
