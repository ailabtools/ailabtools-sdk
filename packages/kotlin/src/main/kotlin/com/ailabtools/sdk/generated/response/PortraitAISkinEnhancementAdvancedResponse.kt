...
/** Typed response data. */
@Serializable
public data class PortraitAISkinEnhancementAdvancedResponseData(
...
@Serializable
public data class PortraitAISkinEnhancementAdvancedResponse(
    @SerialName("request_id")
    ...
    @SerialName("data")
    public val data: PortraitAISkinEnhancementAdvancedResponseData? = null,
    @SerialName("image")
