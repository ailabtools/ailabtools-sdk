...
/** Typed response data. */
@Serializable
public data class PortraitExpressionEditingAdvancedResponseData(
...
@Serializable
public data class PortraitExpressionEditingAdvancedResponse(
    @SerialName("request_id")
    ...
    @SerialName("data")
    public val data: PortraitExpressionEditingAdvancedResponseData? = null,
    @SerialName("image")
