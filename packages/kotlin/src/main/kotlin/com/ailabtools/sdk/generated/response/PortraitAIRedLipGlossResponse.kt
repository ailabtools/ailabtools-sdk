...
/** Typed response data. */
@Serializable
public data class PortraitAIRedLipGlossResponseData(
...
@Serializable
public data class PortraitAIRedLipGlossResponse(
    @SerialName("request_id")
    ...
    @SerialName("data")
    public val data: PortraitAIRedLipGlossResponseData? = null,
    @SerialName("image")
