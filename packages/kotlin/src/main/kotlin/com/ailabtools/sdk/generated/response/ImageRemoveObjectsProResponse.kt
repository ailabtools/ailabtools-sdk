...
/** Typed response data. */
@Serializable
public data class ImageRemoveObjectsProResponseData(
...
@Serializable
public data class ImageRemoveObjectsProResponse(
    ...
    @SerialName("data")
    public val data: ImageRemoveObjectsProResponseData? = null,
    @SerialName("image")
