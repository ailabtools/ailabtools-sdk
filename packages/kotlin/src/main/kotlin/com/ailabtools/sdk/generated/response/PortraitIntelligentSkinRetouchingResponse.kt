...
/** Typed response data. */
@Serializable
public data class PortraitIntelligentSkinRetouchingResponseData(
...
@Serializable
public data class PortraitIntelligentSkinRetouchingResponse(
    ...
    @SerialName("data")
    public val data: PortraitIntelligentSkinRetouchingResponseData? = null,
    @SerialName("image")
