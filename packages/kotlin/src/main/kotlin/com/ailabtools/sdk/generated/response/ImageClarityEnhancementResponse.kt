...
/** Typed response data. */
@Serializable
public data class ImageClarityEnhancementResponseData(
    @SerialName("image")
...
@Serializable
public data class ImageClarityEnhancementResponse(
    ...
    @SerialName("data")
    public val data: ImageClarityEnhancementResponseData? = null,
    @SerialName("image")
    public val image: String? = null,
    @SerialName("ratio")
