...
/** Typed response data. */
@Serializable
public data class CutoutUniversalBackgroundRemovalResponseData(
...
@Serializable
public data class CutoutUniversalBackgroundRemovalResponse(
    ...
    @SerialName("data")
    public val data: CutoutUniversalBackgroundRemovalResponseData? = null,
    @SerialName("image")
