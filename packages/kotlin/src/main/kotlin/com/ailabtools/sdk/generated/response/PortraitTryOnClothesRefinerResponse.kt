...
/** Typed response data. */
@Serializable
public data class PortraitTryOnClothesRefinerResponseData(
...
@Serializable
public data class PortraitTryOnClothesRefinerResponse(
    ...
    @SerialName("data")
    public val data: PortraitTryOnClothesRefinerResponseData? = null,
    @SerialName("image")
