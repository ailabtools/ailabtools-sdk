...
/** Typed response data. */
@Serializable
public data class PortraitFaceAttributeEditingResponseData(
    @SerialName("result")
...
@Serializable
public data class PortraitFaceAttributeEditingResponse(
    ...
    @SerialName("data")
    public val data: PortraitFaceAttributeEditingResponseData? = null,
    @SerialName("image")
    public val image: String? = null,
    @SerialName("ratio")
