...
/** Typed response data. */
@Serializable
public data class ImageCompositionAestheticsScoreResponseData(
    @SerialName("score")
...
@Serializable
public data class ImageCompositionAestheticsScoreResponse(
    ...
    @SerialName("data")
    public val data: ImageCompositionAestheticsScoreResponseData? = null,
    @SerialName("image")
