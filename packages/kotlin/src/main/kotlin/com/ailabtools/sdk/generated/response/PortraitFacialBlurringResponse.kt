...
/** Typed response data. */
@Serializable
public data class PortraitFacialBlurringResponseData(
...
@Serializable
public data class PortraitFacialBlurringResponse(
    ...
    @SerialName("data")
    public val data: PortraitFacialBlurringResponseData? = null,
    @SerialName("image")
