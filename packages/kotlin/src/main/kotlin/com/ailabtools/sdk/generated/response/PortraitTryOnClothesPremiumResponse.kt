...
/** Typed response data. */
@Serializable
public data class PortraitTryOnClothesPremiumResponseData(
...
@Serializable
public data class PortraitTryOnClothesPremiumResponse(
    @SerialName("request_id")
    ...
    @SerialName("data")
    public val data: PortraitTryOnClothesPremiumResponseData? = null,
    @SerialName("image")
