...
/** Typed response data. */
@Serializable
public class ImageQueryingAsyncTaskResultsResponseData

/** Typed response for Querying Async Task Results API. */
@Serializable
public data class ImageQueryingAsyncTaskResultsResponse(
    ...
    @SerialName("data")
    public val data: ImageQueryingAsyncTaskResultsResponseData? = null,
    @SerialName("image")
