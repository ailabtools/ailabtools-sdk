...
/** Typed response data. */
@Serializable
public data class PortraitIntelligentBeautificationResponseData(
...
@Serializable
public data class PortraitIntelligentBeautificationResponse(
    ...
    @SerialName("data")
    public val data: PortraitIntelligentBeautificationResponseData? = null,
    @SerialName("image")
    public val image: String? = null,
    @SerialName("ratio")
