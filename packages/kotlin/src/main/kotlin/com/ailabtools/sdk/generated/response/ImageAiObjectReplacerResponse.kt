...
/** Typed response data. */
@Serializable
public data class ImageAiObjectReplacerResponseData(
...
@Serializable
public data class ImageAiObjectReplacerResponse(
    ...
    @SerialName("data")
    public val data: ImageAiObjectReplacerResponseData? = null,
    @SerialName("image")
