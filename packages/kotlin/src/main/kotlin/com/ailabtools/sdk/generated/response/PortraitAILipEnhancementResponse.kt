...
/** Typed response data. */
@Serializable
public data class PortraitAILipEnhancementResponseData(
...
@Serializable
public data class PortraitAILipEnhancementResponse(
    @SerialName("request_id")
    ...
    @SerialName("data")
    public val data: PortraitAILipEnhancementResponseData? = null,
    @SerialName("image")
