...
/** Typed response data. */
@Serializable
public data class PortraitAIBeardStylingResponseData(
...
@Serializable
public data class PortraitAIBeardStylingResponse(
    @SerialName("request_id")
    ...
    @SerialName("data")
    public val data: PortraitAIBeardStylingResponseData? = null,
    @SerialName("image")
