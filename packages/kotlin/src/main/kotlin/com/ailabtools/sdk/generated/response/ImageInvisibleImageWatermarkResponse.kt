...
/** Typed response data. */
@Serializable
public data class ImageInvisibleImageWatermarkResponseData(
...
@Serializable
public data class ImageInvisibleImageWatermarkResponse(
    ...
    @SerialName("data")
    public val data: ImageInvisibleImageWatermarkResponseData? = null,
    @SerialName("image")
