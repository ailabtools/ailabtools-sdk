...
/** Typed response data. */
@Serializable
public data class ImageDistortionCorrectionResponseData(
    @SerialName("image")
...
@Serializable
public data class ImageDistortionCorrectionResponse(
    ...
    @SerialName("data")
    public val data: ImageDistortionCorrectionResponseData? = null,
    @SerialName("image")
    public val image: String? = null,
    @SerialName("ratio")
