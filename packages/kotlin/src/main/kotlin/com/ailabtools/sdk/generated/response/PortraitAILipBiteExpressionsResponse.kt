...
/** Typed response data. */
@Serializable
public data class PortraitAILipBiteExpressionsResponseData(
...
@Serializable
public data class PortraitAILipBiteExpressionsResponse(
    @SerialName("request_id")
    ...
    @SerialName("data")
    public val data: PortraitAILipBiteExpressionsResponseData? = null,
    @SerialName("image")
