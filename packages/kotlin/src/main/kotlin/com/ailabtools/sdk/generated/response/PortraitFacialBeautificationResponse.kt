...
/** Typed response data. */
@Serializable
public data class PortraitFacialBeautificationResponseData(
...
@Serializable
public data class PortraitFacialBeautificationResponse(
    ...
    @SerialName("data")
    public val data: PortraitFacialBeautificationResponseData? = null,
    @SerialName("image")
