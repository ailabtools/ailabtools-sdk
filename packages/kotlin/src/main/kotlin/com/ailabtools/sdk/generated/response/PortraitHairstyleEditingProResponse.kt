...
/** Typed response data. */
@Serializable
public data class PortraitHairstyleEditingProResponseData(
...
@Serializable
public data class PortraitHairstyleEditingProResponse(
    ...
    @SerialName("data")
    public val data: PortraitHairstyleEditingProResponseData? = null,
    @SerialName("image")
