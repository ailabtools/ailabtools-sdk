...
/** Typed response data. */
@Serializable
public data class PortraitAIEyeshadowTryOnResponseData(
...
@Serializable
public data class PortraitAIEyeshadowTryOnResponse(
    @SerialName("request_id")
    ...
    @SerialName("data")
    public val data: PortraitAIEyeshadowTryOnResponseData? = null,
    @SerialName("image")
