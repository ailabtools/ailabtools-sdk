...
/** Typed response data. */
@Serializable
public data class ImageAIEmojiGeneratorResponseData(
...
@Serializable
public data class ImageAIEmojiGeneratorResponse(
    @SerialName("request_id")
    ...
    @SerialName("data")
    public val data: ImageAIEmojiGeneratorResponseData? = null,
    @SerialName("image")
