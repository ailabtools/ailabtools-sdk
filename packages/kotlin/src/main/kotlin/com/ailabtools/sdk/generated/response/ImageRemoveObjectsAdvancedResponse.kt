...
/** Typed response data. */
@Serializable
public data class ImageRemoveObjectsAdvancedResponseData(
    @SerialName("binary_data_base64")
    public val binaryDataBase64: List<String>? = null,
)

/** Typed response for Remove Objects Advanced API. */
@Serializable
public data class ImageRemoveObjectsAdvancedResponse(
    ...
    @SerialName("data")
    public val data: ImageRemoveObjectsAdvancedResponseData? = null,
    @SerialName("image")
