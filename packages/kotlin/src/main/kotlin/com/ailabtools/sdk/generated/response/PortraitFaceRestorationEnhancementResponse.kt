...
/** Typed response data. */
@Serializable
public data class PortraitFaceRestorationEnhancementResponseData(
...
@Serializable
public data class PortraitFaceRestorationEnhancementResponse(
    ...
    @SerialName("data")
    public val data: PortraitFaceRestorationEnhancementResponseData? = null,
    @SerialName("image")
