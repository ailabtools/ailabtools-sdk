...
/** Typed response data. */
@Serializable
public data class ImageExposureRatingResponseData(
    @SerialName("exposure")
    public val exposure: Double? = null,
)

/** Typed response for Image Exposure Score API. */
@Serializable
public data class ImageExposureRatingResponse(
    ...
    @SerialName("data")
    public val data: ImageExposureRatingResponseData? = null,
    @SerialName("image")
