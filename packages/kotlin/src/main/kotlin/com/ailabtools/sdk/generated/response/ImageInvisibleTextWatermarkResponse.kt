...
/** Typed response data. */
@Serializable
public data class ImageInvisibleTextWatermarkResponseData(
    @SerialName("watermark_image_url")
    public val watermarkImageUrl: String? = null,
    @SerialName("text_image_url")
    public val textImageUrl: String? = null,
)

/** Typed response for Image Invisible Text Watermark API. */
@Serializable
public data class ImageInvisibleTextWatermarkResponse(
    ...
    @SerialName("data")
    public val data: ImageInvisibleTextWatermarkResponseData? = null,
    @SerialName("image")
