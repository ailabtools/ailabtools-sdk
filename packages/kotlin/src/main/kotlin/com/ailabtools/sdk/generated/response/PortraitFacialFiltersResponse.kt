...
/** Typed response data. */
@Serializable
public data class PortraitFacialFiltersResponseData(
...
@Serializable
public data class PortraitFacialFiltersResponse(
    ...
    @SerialName("data")
    public val data: PortraitFacialFiltersResponseData? = null,
    @SerialName("image")
