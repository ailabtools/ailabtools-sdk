...
/** Typed response data. */
@Serializable
public data class PortraitHairstyleEditingPremiumResponseData(
...
@Serializable
public data class PortraitHairstyleEditingPremiumResponse(
    @SerialName("request_id")
    ...
    @SerialName("data")
    public val data: PortraitHairstyleEditingPremiumResponseData? = null,
    @SerialName("image")
