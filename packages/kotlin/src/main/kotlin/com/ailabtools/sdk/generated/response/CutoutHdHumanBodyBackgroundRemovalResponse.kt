...
@Serializable
public data class CutoutHdHumanBodyBackgroundRemovalElement(
...
/** Typed response data. */
@Serializable
public data class CutoutHdHumanBodyBackgroundRemovalResponseData(
    ...
    @SerialName("elements")
    public val elements: List<CutoutHdHumanBodyBackgroundRemovalElement>? = null,
)

/** Typed response for HD Human Background Removal API. */
@Serializable
public data class CutoutHdHumanBodyBackgroundRemovalResponse(
    @SerialName("request_id")
    ...
    @SerialName("data")
    public val data: CutoutHdHumanBodyBackgroundRemovalResponseData? = null,
    @SerialName("image")
