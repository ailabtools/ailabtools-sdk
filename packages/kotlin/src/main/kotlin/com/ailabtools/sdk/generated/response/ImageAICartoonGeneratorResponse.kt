...
/** Typed response data. */
@Serializable
public data class ImageAICartoonGeneratorResponseData(
...
@Serializable
public data class ImageAICartoonGeneratorResponse(
    ...
    @SerialName("data")
    public val data: ImageAICartoonGeneratorResponseData? = null,
    @SerialName("image")
