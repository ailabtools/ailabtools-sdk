...
/** Typed response data. */
@Serializable
public data class PortraitAIButtEnhancementResponseData(
...
@Serializable
public data class PortraitAIButtEnhancementResponse(
    @SerialName("request_id")
    ...
    @SerialName("data")
    public val data: PortraitAIButtEnhancementResponseData? = null,
    @SerialName("image")
