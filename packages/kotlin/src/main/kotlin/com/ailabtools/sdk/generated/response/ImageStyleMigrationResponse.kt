...
/** Typed response data. */
@Serializable
public data class ImageStyleMigrationResponseData(
    @SerialName("url")
    public val url: String? = null,
    @SerialName("major_url")
    public val majorUrl: String? = null,
)

/** Typed response for Style Transfer API. */
@Serializable
public data class ImageStyleMigrationResponse(
    ...
    @SerialName("data")
    public val data: ImageStyleMigrationResponseData? = null,
    @SerialName("image")
