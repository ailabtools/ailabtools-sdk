...
/** Typed response data. */
@Serializable
public data class ImageAIFlowerWallpaperResponseData(
...
@Serializable
public data class ImageAIFlowerWallpaperResponse(
    @SerialName("request_id")
    ...
    @SerialName("data")
    public val data: ImageAIFlowerWallpaperResponseData? = null,
    @SerialName("image")
