...
/** Typed response data. */
@Serializable
public data class PortraitLipsColorChangerResponseData(
...
@Serializable
public data class PortraitLipsColorChangerResponse(
    ...
    @SerialName("data")
    public val data: PortraitLipsColorChangerResponseData? = null,
    @SerialName("image")
