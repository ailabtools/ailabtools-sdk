...
/** Typed response data. */
@Serializable
public data class CutoutFoodBackgroundRemovalResponseData(
...
@Serializable
public data class CutoutFoodBackgroundRemovalResponse(
    ...
    @SerialName("data")
    public val data: CutoutFoodBackgroundRemovalResponseData? = null,
    @SerialName("image")
