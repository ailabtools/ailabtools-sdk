...
/** Typed response data. */
@Serializable
public data class ImageContrastEnhancementResponseData(
    @SerialName("image")
...
@Serializable
public data class ImageContrastEnhancementResponse(
    ...
    @SerialName("data")
    public val data: ImageContrastEnhancementResponseData? = null,
    @SerialName("image")
    public val image: String? = null,
    @SerialName("ratio")
