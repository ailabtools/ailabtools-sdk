...
/** Typed response data. */
@Serializable
public data class PortraitAIColoredContactsResponseData(
...
@Serializable
public data class PortraitAIColoredContactsResponse(
    @SerialName("request_id")
    ...
    @SerialName("data")
    public val data: PortraitAIColoredContactsResponseData? = null,
    @SerialName("image")
