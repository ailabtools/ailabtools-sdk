...
/** Typed response data. */
@Serializable
public data class PortraitCartoonYourselfResponseData(
...
@Serializable
public data class PortraitCartoonYourselfResponse(
    ...
    @SerialName("data")
    public val data: PortraitCartoonYourselfResponseData? = null,
    @SerialName("image")
