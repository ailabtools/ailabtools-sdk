...
/** Typed response data. */
@Serializable
public data class PortraitAIBreastExpansionResponseData(
...
@Serializable
public data class PortraitAIBreastExpansionResponse(
    @SerialName("request_id")
    ...
    @SerialName("data")
    public val data: PortraitAIBreastExpansionResponseData? = null,
    @SerialName("image")
    public val image: String? = null,
    @SerialName("ratio")
