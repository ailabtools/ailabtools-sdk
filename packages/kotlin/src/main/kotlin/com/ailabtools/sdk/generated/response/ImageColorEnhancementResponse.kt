...
/** Typed response data. */
@Serializable
public data class ImageColorEnhancementResponseData(
...
@Serializable
public data class ImageColorEnhancementResponse(
    ...
    @SerialName("data")
    public val data: ImageColorEnhancementResponseData? = null,
    @SerialName("image")
