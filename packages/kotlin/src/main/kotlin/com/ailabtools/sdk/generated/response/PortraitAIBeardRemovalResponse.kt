...
/** Typed response data. */
@Serializable
public data class PortraitAIBeardRemovalResponseData(
...
@Serializable
public data class PortraitAIBeardRemovalResponse(
    @SerialName("request_id")
    ...
    @SerialName("data")
    public val data: PortraitAIBeardRemovalResponseData? = null,
    @SerialName("image")
