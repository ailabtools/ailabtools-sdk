...
/** Typed response data. */
@Serializable
public data class PortraitExpressionEditingResponseData(
    @SerialName("image")
...
@Serializable
public data class PortraitExpressionEditingResponse(
    ...
    @SerialName("data")
    public val data: PortraitExpressionEditingResponseData? = null,
    @SerialName("image")
    public val image: String? = null,
    @SerialName("ratio")
