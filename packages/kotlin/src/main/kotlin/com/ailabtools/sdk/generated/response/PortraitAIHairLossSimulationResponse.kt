...
/** Typed response data. */
@Serializable
public data class PortraitAIHairLossSimulationResponseData(
...
@Serializable
public data class PortraitAIHairLossSimulationResponse(
    @SerialName("request_id")
    ...
    @SerialName("data")
    public val data: PortraitAIHairLossSimulationResponseData? = null,
    @SerialName("image")
