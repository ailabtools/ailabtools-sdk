...
/** Typed response data. */
@Serializable
public data class PortraitAIBigHeadEffectResponseData(
...
@Serializable
public data class PortraitAIBigHeadEffectResponse(
    @SerialName("request_id")
    ...
    @SerialName("data")
    public val data: PortraitAIBigHeadEffectResponseData? = null,
    @SerialName("image")
