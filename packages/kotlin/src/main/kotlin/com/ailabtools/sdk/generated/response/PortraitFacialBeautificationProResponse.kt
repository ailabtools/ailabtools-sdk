...
/** Typed response data. */
@Serializable
public data class PortraitFacialBeautificationProResponseData(
...
@Serializable
public data class PortraitFacialBeautificationProResponse(
    ...
    @SerialName("data")
    public val data: PortraitFacialBeautificationProResponseData? = null,
    @SerialName("image")
