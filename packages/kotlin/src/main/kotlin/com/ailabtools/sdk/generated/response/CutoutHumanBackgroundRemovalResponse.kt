...
/** Typed response data. */
@Serializable
public data class CutoutHumanBackgroundRemovalResponseData(
...
@Serializable
public data class CutoutHumanBackgroundRemovalResponse(
    ...
    @SerialName("data")
    public val data: CutoutHumanBackgroundRemovalResponseData? = null,
    @SerialName("image")
