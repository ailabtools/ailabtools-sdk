...
/** Typed response data. */
@Serializable
public data class ImageLosslessEnlargementResponseData(
    @SerialName("url")
...
@Serializable
public data class ImageLosslessEnlargementResponse(
    ...
    @SerialName("data")
    public val data: ImageLosslessEnlargementResponseData? = null,
    @SerialName("image")
