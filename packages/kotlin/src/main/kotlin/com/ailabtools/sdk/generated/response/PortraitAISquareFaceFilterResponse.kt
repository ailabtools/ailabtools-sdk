...
/** Typed response data. */
@Serializable
public data class PortraitAISquareFaceFilterResponseData(
...
@Serializable
public data class PortraitAISquareFaceFilterResponse(
    @SerialName("request_id")
    ...
    @SerialName("data")
    public val data: PortraitAISquareFaceFilterResponseData? = null,
    @SerialName("image")
