...
/** Typed response data. */
@Serializable
public data class PortraitFacialBeautificationAdvancedResponseData(
    @SerialName("result_image")
    public val resultImage: String? = null,
)

/** Typed response for Face Beauty Advanced API. */
@Serializable
public data class PortraitFacialBeautificationAdvancedResponse(
    ...
    @SerialName("data")
    public val data: PortraitFacialBeautificationAdvancedResponseData? = null,
    @SerialName("image")
