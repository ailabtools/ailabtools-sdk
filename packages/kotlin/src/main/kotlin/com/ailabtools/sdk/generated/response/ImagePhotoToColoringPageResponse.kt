...
/** Typed response data. */
@Serializable
public data class ImagePhotoToColoringPageResponseData(
...
@Serializable
public data class ImagePhotoToColoringPageResponse(
    @SerialName("request_id")
    ...
    @SerialName("data")
    public val data: ImagePhotoToColoringPageResponseData? = null,
    @SerialName("image")
