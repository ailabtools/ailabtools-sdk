...
/** Typed response data. */
@Serializable
public data class PortraitHairstyleEditingResponseData(
    @SerialName("image")
...
@Serializable
public data class PortraitHairstyleEditingResponse(
    ...
    @SerialName("data")
    public val data: PortraitHairstyleEditingResponseData? = null,
    @SerialName("image")
    public val image: String? = null,
    @SerialName("ratio")
