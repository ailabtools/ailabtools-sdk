...
/** Typed response data. */
@Serializable
public data class PortraitAIHalloweenMaskResponseData(
...
@Serializable
public data class PortraitAIHalloweenMaskResponse(
    @SerialName("request_id")
    ...
    @SerialName("data")
    public val data: PortraitAIHalloweenMaskResponseData? = null,
    @SerialName("image")
