...
/** Typed response data. */
@Serializable
public data class CommonQueryAsyncTaskResultResponseData(
    @SerialName("task_status")
    public val taskStatus: Int? = null,
)

/** Typed response for Querying Async Task Results API. */
@Serializable
public data class CommonQueryAsyncTaskResultResponse(
    ...
    @SerialName("data")
    public val data: CommonQueryAsyncTaskResultResponseData? = null,
    @SerialName("image")
