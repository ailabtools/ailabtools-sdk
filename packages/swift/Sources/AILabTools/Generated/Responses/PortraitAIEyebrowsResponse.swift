...
/// Response data for AI Eyebrows API.
public struct PortraitAIEyebrowsResponseData: Decodable {
...
public struct PortraitAIEyebrowsResponse: Decodable {
    public let requestId: String?
    public let logId: String?
    ...
    public let data: PortraitAIEyebrowsResponseData?
