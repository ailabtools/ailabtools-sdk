...
public struct ImageQueryingAsyncTaskResultsResponseData: Decodable {
}

/// Typed response for Querying Async Task Results API.
public struct ImageQueryingAsyncTaskResultsResponse: Decodable {
    ...
    public let data: ImageQueryingAsyncTaskResultsResponseData?
