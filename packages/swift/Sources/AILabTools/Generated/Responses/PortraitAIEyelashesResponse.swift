...
/// Response data for AI Eyelashes API.
public struct PortraitAIEyelashesResponseData: Decodable {
...
public struct PortraitAIEyelashesResponse: Decodable {
    public let requestId: String?
    public let logId: String?
    ...
    public let data: PortraitAIEyelashesResponseData?
