...
public struct PortraitFacialBeautificationProResponseData: Decodable {
...
public struct PortraitFacialBeautificationProResponse: Decodable {
    ...
    public let data: PortraitFacialBeautificationProResponseData?
