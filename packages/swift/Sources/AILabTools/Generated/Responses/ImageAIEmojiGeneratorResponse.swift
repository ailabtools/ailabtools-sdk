...
/// Response data for AI Emoji Generator API.
public struct ImageAIEmojiGeneratorResponseData: Decodable {
...
public struct ImageAIEmojiGeneratorResponse: Decodable {
    public let requestId: String?
    public let logId: String?
    public let errorCode: Int?
    ...
    public let data: ImageAIEmojiGeneratorResponseData?
