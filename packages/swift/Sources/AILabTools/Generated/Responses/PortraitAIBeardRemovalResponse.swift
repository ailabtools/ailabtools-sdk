...
/// Response data for AI Beard Removal API.
public struct PortraitAIBeardRemovalResponseData: Decodable {
...
public struct PortraitAIBeardRemovalResponse: Decodable {
    public let requestId: String?
    public let logId: String?
    ...
    public let data: PortraitAIBeardRemovalResponseData?
