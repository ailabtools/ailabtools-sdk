...
public struct CommonQueryAsyncTaskResultResponseData: Decodable {
...
public struct CommonQueryAsyncTaskResultResponse: Decodable {
    ...
    public let data: CommonQueryAsyncTaskResultResponseData?
