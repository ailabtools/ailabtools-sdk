...
/// Response data for AI Halloween Mask API.
public struct PortraitAIHalloweenMaskResponseData: Decodable {
...
public struct PortraitAIHalloweenMaskResponse: Decodable {
    public let requestId: String?
    public let logId: String?
    ...
    public let data: PortraitAIHalloweenMaskResponseData?
