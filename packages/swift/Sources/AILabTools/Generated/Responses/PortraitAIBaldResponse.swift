...
/// Response data for AI Bald API.
public struct PortraitAIBaldResponseData: Decodable {
...
public struct PortraitAIBaldResponse: Decodable {
    public let requestId: String?
    public let logId: String?
    ...
    public let data: PortraitAIBaldResponseData?
