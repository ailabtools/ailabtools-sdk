...
/// Response data for AI Waist Slimming API.
public struct PortraitAIWaistSlimmingResponseData: Decodable {
...
public struct PortraitAIWaistSlimmingResponse: Decodable {
    public let requestId: String?
    public let logId: String?
    ...
    public let data: PortraitAIWaistSlimmingResponseData?
