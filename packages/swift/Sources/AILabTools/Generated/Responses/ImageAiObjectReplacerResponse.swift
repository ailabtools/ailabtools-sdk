...
/// Response data for AI Object Replacer API.
public struct ImageAiObjectReplacerResponseData: Decodable {
...
public struct ImageAiObjectReplacerResponse: Decodable {
    ...
    public let data: ImageAiObjectReplacerResponseData?
