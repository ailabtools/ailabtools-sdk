...
public struct ImageRemoveObjectsAdvancedResponseData: Decodable {
...
public struct ImageRemoveObjectsAdvancedResponse: Decodable {
    ...
    public let data: ImageRemoveObjectsAdvancedResponseData?
