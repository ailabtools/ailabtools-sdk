...
/// Response data for AI Hair Color API.
public struct PortraitAIHairColorResponseData: Decodable {
...
public struct PortraitAIHairColorResponse: Decodable {
    public let requestId: String?
    public let logId: String?
    ...
    public let data: PortraitAIHairColorResponseData?
