...
/// Response data for AI Nail Art API.
public struct ImageAINailArtResponseData: Decodable {
...
public struct ImageAINailArtResponse: Decodable {
    public let requestId: String?
    public let logId: String?
    public let errorCode: Int?
    ...
    public let data: ImageAINailArtResponseData?
