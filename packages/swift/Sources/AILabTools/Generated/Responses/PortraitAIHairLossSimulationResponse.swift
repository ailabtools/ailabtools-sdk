...
/// Response data for AI Hair Loss Simulation API.
public struct PortraitAIHairLossSimulationResponseData: Decodable {
...
public struct PortraitAIHairLossSimulationResponse: Decodable {
    public let requestId: String?
    public let logId: String?
    ...
    public let data: PortraitAIHairLossSimulationResponseData?
