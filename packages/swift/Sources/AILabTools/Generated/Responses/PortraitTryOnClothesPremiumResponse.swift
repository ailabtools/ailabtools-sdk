...
/// Response data for Try on Clothes Premium API.
public struct PortraitTryOnClothesPremiumResponseData: Decodable {
...
public struct PortraitTryOnClothesPremiumResponse: Decodable {
    public let requestId: String?
    public let logId: String?
    public let errorCode: Int?
    ...
    public let data: PortraitTryOnClothesPremiumResponseData?
