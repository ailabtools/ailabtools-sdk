...
/// Response data for AI Big Head Effect API.
public struct PortraitAIBigHeadEffectResponseData: Decodable {
...
public struct PortraitAIBigHeadEffectResponse: Decodable {
    public let requestId: String?
    public let logId: String?
    ...
    public let data: PortraitAIBigHeadEffectResponseData?
