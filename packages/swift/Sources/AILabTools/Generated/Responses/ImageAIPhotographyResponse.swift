...
/// Response data for AI Photography API.
public struct ImageAIPhotographyResponseData: Decodable {
...
/// Typed response for AI Photography API.
public struct ImageAIPhotographyResponse: Decodable {
    public let requestId: String?
    public let logId: String?
    public let errorCode: Int?
    ...
    public let data: ImageAIPhotographyResponseData?
