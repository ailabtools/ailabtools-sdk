...
public struct ImageColorEnhancementResponseData: Decodable {
...
public struct ImageColorEnhancementResponse: Decodable {
    ...
    public let data: ImageColorEnhancementResponseData?
