...
public struct ImageExposureRatingResponseData: Decodable {
...
public struct ImageExposureRatingResponse: Decodable {
    ...
    public let data: ImageExposureRatingResponseData?
