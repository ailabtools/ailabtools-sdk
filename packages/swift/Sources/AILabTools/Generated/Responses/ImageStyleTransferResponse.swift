...
public struct ImageStyleTransferResponseData: Decodable {
...
public struct ImageStyleTransferResponse: Decodable {
    ...
    public let data: ImageStyleTransferResponseData?
    public let image: String?
