...
/// Response data for AI Eyeshadow Try-On API.
public struct PortraitAIEyeshadowTryOnResponseData: Decodable {
...
public struct PortraitAIEyeshadowTryOnResponse: Decodable {
    public let requestId: String?
    public let logId: String?
    ...
    public let data: PortraitAIEyeshadowTryOnResponseData?
