...
public struct PortraitCartoonYourselfResponseData: Decodable {
...
public struct PortraitCartoonYourselfResponse: Decodable {
    ...
    public let data: PortraitCartoonYourselfResponseData?
