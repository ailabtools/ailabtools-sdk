...
/// Response data for Photo to Coloring Page API.
public struct ImagePhotoToColoringPageResponseData: Decodable {
...
public struct ImagePhotoToColoringPageResponse: Decodable {
    public let requestId: String?
    public let logId: String?
    public let errorCode: Int?
    ...
    public let data: ImagePhotoToColoringPageResponseData?
