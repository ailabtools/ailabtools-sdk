...
/// Response data for AI Square Face Filter API.
public struct PortraitAISquareFaceFilterResponseData: Decodable {
...
public struct PortraitAISquareFaceFilterResponse: Decodable {
    public let requestId: String?
    public let logId: String?
    ...
    public let data: PortraitAISquareFaceFilterResponseData?
