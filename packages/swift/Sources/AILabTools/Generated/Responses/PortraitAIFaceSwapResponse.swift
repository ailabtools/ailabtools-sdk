...
/// Response data for AI Face Swap API.
public struct PortraitAIFaceSwapResponseData: Decodable {
...
/// Typed response for AI Face Swap API.
public struct PortraitAIFaceSwapResponse: Decodable {
    public let requestId: String?
    public let logId: String?
    public let errorCode: Int?
    ...
    public let data: PortraitAIFaceSwapResponseData?
