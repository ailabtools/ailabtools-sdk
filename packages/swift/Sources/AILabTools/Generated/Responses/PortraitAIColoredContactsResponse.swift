...
/// Response data for AI Colored Contacts API.
public struct PortraitAIColoredContactsResponseData: Decodable {
...
public struct PortraitAIColoredContactsResponse: Decodable {
    public let requestId: String?
    public let logId: String?
    ...
    public let data: PortraitAIColoredContactsResponseData?
