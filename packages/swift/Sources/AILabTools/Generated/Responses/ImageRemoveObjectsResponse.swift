...
public struct ImageRemoveObjectsResponseData: Decodable {
...
public struct ImageRemoveObjectsResponse: Decodable {
    ...
    public let data: ImageRemoveObjectsResponseData?
