...
public struct ImageRemoveObjectsProResponseData: Decodable {
...
public struct ImageRemoveObjectsProResponse: Decodable {
    ...
    public let data: ImageRemoveObjectsProResponseData?
