...
public struct PortraitFaceFusionResponseData: Decodable {
...
public struct PortraitFaceFusionResponse: Decodable {
    ...
    public let data: PortraitFaceFusionResponseData?
    public let image: String?
