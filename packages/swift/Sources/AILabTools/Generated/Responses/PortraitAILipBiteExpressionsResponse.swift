...
/// Response data for AI Lip Bite Expressions API.
public struct PortraitAILipBiteExpressionsResponseData: Decodable {
...
public struct PortraitAILipBiteExpressionsResponse: Decodable {
    public let requestId: String?
    public let logId: String?
    ...
    public let data: PortraitAILipBiteExpressionsResponseData?
