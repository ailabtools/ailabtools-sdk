...
/// Response data for AI Beard Styling API.
public struct PortraitAIBeardStylingResponseData: Decodable {
...
public struct PortraitAIBeardStylingResponse: Decodable {
    public let requestId: String?
    public let logId: String?
    ...
    public let data: PortraitAIBeardStylingResponseData?
