...
public struct PortraitHairstyleEditingResponseData: Decodable {
...
public struct PortraitHairstyleEditingResponse: Decodable {
    ...
    public let data: PortraitHairstyleEditingResponseData?
    public let image: String?
