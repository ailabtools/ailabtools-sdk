...
/// Response data for AI Butt Enhancement API.
public struct PortraitAIButtEnhancementResponseData: Decodable {
...
public struct PortraitAIButtEnhancementResponse: Decodable {
    public let requestId: String?
    public let logId: String?
    ...
    public let data: PortraitAIButtEnhancementResponseData?
