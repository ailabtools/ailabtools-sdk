...
/// Response data for AI Fat Filter API.
public struct PortraitAIFatFilterResponseData: Decodable {
...
public struct PortraitAIFatFilterResponse: Decodable {
    public let requestId: String?
    public let logId: String?
    ...
    public let data: PortraitAIFatFilterResponseData?
