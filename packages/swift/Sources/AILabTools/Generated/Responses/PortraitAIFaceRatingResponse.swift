...
/// Response data for AI Face Rating API.
public struct PortraitAIFaceRatingResponseData: Decodable {
...
public struct PortraitAIFaceRatingResponse: Decodable {
    public let requestId: String?
    public let logId: String?
    ...
    public let data: PortraitAIFaceRatingResponseData?
