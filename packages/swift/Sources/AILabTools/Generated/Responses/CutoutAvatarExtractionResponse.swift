...
/// Response data for Head Extraction API.
public struct CutoutAvatarExtractionResponseData: Decodable {
...
public struct CutoutAvatarExtractionResponse: Decodable {
    ...
    public let data: CutoutAvatarExtractionResponseData?
