...
public struct PortraitHairstyleEditingPremiumParams {
...
extension PortraitHairstyleEditingPremiumParams: RequestParameters {
    ...
    func bodyFields() -> [String: RequestValue] {
        ...
        if let value = hairStyle { fields["hair_style"] = .string(value) }
        if let value = color { fields["color"] = .string(value) }
        return fields
    }

    func validate() throws {
        if hairStyle == nil && imageTemplate == nil { throw AILabToolsError.invalidParameter("At least one of hairStyle, imageTemplate is required") }
    }
}
