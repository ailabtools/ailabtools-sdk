...
AILabTools provides official SDKs for Node.js, TypeScript, Python, Go, Dart, Flutter, PHP, Ruby, Rust, Java, Kotlin/Android, C#/.NET, and Swift. Every SDK covers the same AI image APIs for background removal, image enhancement, object removal, portrait editing, hairstyle changes, skin analysis, and virtual try-on.
...
| Rust | crates.io package `ailabtools` | `cargo add ailabtools` |
...
| Rust | Rust 1.70 | `async` / `await` with reqwest | path or byte vector | Shared reqwest client; no explicit close method |
...
- [AILabTools SDK GitHub Repository](https://github.com/ailabtools/ailabtools-sdk) contains the Node.js, Python, Go, Dart, Flutter, PHP, Ruby, Rust, Java, Kotlin/Android, C#/.NET, and Swift SDK source.
...
- The Rust SDK is asynchronous, uses `reqwest`, and is structured for crates.io.
